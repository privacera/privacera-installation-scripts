...
if [ -z "$PRIVACERA_HUB_PASSWORD" ] || [ -z "$ANSIBLE_VAULT_PASSWORD" ] || [ -z "$AWS_REGION" ]; then
...
echo "RANGER_PLUGIN_SERVICE_ANNOTATIONS have been set in custom-vars/vars.ranger-plugin.yml"
